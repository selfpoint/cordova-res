...
export type TransformFunction = (image: ImageSchema, pipeline: Sharp) => Promise<Sharp> | Sharp;
...
export type UnconsolidatedGeneratedAndroidAdaptiveIconResource = AndroidAdaptiveIconResourceConfig & GeneratedImageResource;
/**
