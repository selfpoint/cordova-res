...
export type UnknownResource = Partial<ResourceKeyValues> & PlatformAndType<Platform, ResourceType>;
export type BaseResourceConfig<P extends Platform, T extends ResourceType, R extends keyof ResourceKeyValues> = {
    [K in R]: ResourceKeyValues[K];
} & PlatformAndType<P, T>;
export type ImageResourceKey = ResourceKey.FORMAT | ResourceKey.WIDTH | ResourceKey.HEIGHT;
export type AndroidAdaptiveIconResourceConfig = BaseResourceConfig<Platform.ANDROID, ResourceType.ADAPTIVE_ICON, ImageResourceKey | ResourceKey.FOREGROUND | ResourceKey.BACKGROUND | ResourceKey.DENSITY>;
export type AndroidIconResourceConfig = BaseResourceConfig<Platform.ANDROID, ResourceType.ICON, ImageResourceKey | ResourceKey.SRC | ResourceKey.DENSITY>;
export type AndroidSplashResourceConfig = BaseResourceConfig<Platform.ANDROID, ResourceType.SPLASH, ImageResourceKey | ResourceKey.SRC | ResourceKey.DENSITY | ResourceKey.ORIENTATION>;
export type IOSIconResourceConfig = BaseResourceConfig<Platform.IOS, ResourceType.ICON, ImageResourceKey | ResourceKey.SRC | ResourceKey.SCALE>;
export type IOSSplashResourceConfig = BaseResourceConfig<Platform.IOS, ResourceType.SPLASH, ImageResourceKey | ResourceKey.SRC | ResourceKey.ORIENTATION | ResourceKey.SCALE>;
export type WindowsIconResourceConfig = BaseResourceConfig<Platform.WINDOWS, ResourceType.ICON, ImageResourceKey | ResourceKey.SRC | ResourceKey.TARGET | ResourceKey.SCALE>;
export type WindowsSplashResourceConfig = BaseResourceConfig<Platform.WINDOWS, ResourceType.SPLASH, ImageResourceKey | ResourceKey.SRC | ResourceKey.ORIENTATION | ResourceKey.TARGET | ResourceKey.SCALE>;
export type SimpleResourceConfig = AndroidIconResourceConfig | AndroidSplashResourceConfig | IOSIconResourceConfig | IOSSplashResourceConfig | WindowsIconResourceConfig | WindowsSplashResourceConfig;
export type ResourceConfig = AndroidAdaptiveIconResourceConfig | SimpleResourceConfig;
...
export declare const ANDROID_SCREEN: AndroidSplashResourceConfig;
export declare const ANDROID_SCREEN_DARK: AndroidSplashResourceConfig;
