...
exports.IOS_SPLASH_RESOURCES = exports.IOS_2X_UNIVERSAL_ANYANY_SPLASH = exports.IOS_IPHONE_SPLASH = void 0;
...
exports.RESOURCE_TYPES = [
    ...
    "splash" /* ResourceType.SPLASH */,
];
exports.RESOURCE_FORMATS = ["jpeg" /* Format.JPEG */, "png" /* Format.PNG */];
...
async function validateRasterResource(platform, type, source, metadata, schema, errstream) {
    ...
    if (!format || !isRasterResourceFormat(format)) {
        throw new error_1.ValidationError(util_1.default.format(`The format of source images for %s %s must be one of: (%s) (image format is "%s").`, (0, platform_1.prettyPlatform)(platform), prettyResourceType(type, { pluralize: true }), exports.RESOURCE_RASTER_FORMATS.join(', '), format), {
            source,
            type,
            code: "BAD_IMAGE_FORMAT" /* ValidationErrorCode.BAD_IMAGE_FORMAT */,
            format,
            requiredFormats: exports.RESOURCE_RASTER_FORMATS,
        });
    }
    if (!width || !height || width < requiredWidth || height < requiredHeight) {
        throw new error_1.ValidationError(util_1.default.format(`The dimensions of source images for %s %s do not meet minimum size requirements: %dx%d (image is %dx%d).`, (0, platform_1.prettyPlatform)(platform), prettyResourceType(type, { pluralize: true }), requiredWidth, requiredHeight, width, height), {
            source,
            type,
            code: "BAD_IMAGE_SIZE" /* ValidationErrorCode.BAD_IMAGE_SIZE */,
            width,
            height,
            requiredWidth,
            requiredHeight,
    ...
    if (!schema.alpha && metadata.hasAlpha) {
        const platformSpecificMessage = platform === "ios" /* Platform.IOS */ && type === "icon" /* ResourceType.ICON */
            ? '\n' +
        ...
        errstream === null || errstream === void 0 ? void 0 : errstream.write(util_1.default.format('WARN:\tSource %s "%s" contains alpha channel, generated %s for %s will not.\n' +
            platformSpecificMessage, prettyResourceType(type), source, prettyResourceType(type, { pluralize: true }), (0, platform_1.prettyPlatform)(platform)) + '\n');
    }
}
...
exports.WINDOWS_SQUARE_44_X_44_ICON = {
    ...
    type: "icon" /* ResourceType.ICON */,
    src: 'Square44x44Logo.png',
    format: "none" /* Format.NONE */,
    width: 44,
    height: 44,
    target: "Square44x44Logo" /* Target.SQUARE_44_X_44_LOGO */,
    scale: 1,
};
/**
...
exports.WINDOWS_SQUARE_71_X_71_ICON = {
    ...
    width: 71,
    height: 71,
    target: "Square71x71Logo" /* Target.SQUARE_71_X_71_LOGO */,
    scale: 1,
};
/**
...
exports.WINDOWS_SQUARE_150_X_150_ICON = {
    ...
    width: 150,
    height: 150,
    target: "Square150x150Logo" /* Target.SQUARE_150_X_150_LOGO */,
    scale: 1,
};
/**
...
exports.WINDOWS_SQUARE_310_X_310_ICON = {
    ...
    width: 310,
    height: 310,
    target: "Square310x310Logo" /* Target.SQUARE_310_X_310_LOGO */,
    scale: 1,
};
/**
...
exports.WINDOWS_WIDE_310_X_150_LOGO = {
    ...
    width: 310,
    height: 150,
    target: "Wide310x150Logo" /* Target.WIDE_310_X_150_LOGO */,
    scale: 1,
};
/**
...
exports.WINDOWS_STORE_LOGO = {
    ...
    width: 50,
    height: 50,
    target: "StoreLogo" /* Target.STORE_LOGO */,
    scale: 1,
};
/**
...
exports.WINDOWS_SPLASH_SCREEN = {
    platform: "windows" /* Platform.WINDOWS */,
    type: "splash" /* ResourceType.SPLASH */,
    src: 'Splash.png',
    format: "none" /* Format.NONE */,
    width: 620,
    height: 300,
    orientation: "landscape" /* Orientation.LANDSCAPE */,
    target: "SplashScreen" /* Target.SPLASH_SCREEN */,
    scale: 1,
};
/**
 * @see https://msdn.microsoft.com/en-us/windows/desktop/hh465338
...
exports.ANDROID_XXXHDPI_ADAPTIVE_ICON = {
    ...
    width: 432,
    height: 432,
    density: "xxxhdpi" /* Density.XXXHDPI */,
};
...
exports.ANDROID_SCREEN_DARK = {
    ...
    width: 320,
    height: 240,
    density: "defaultNight" /* Density.DEFAULT_NIGHT */,
    orientation: "default" /* Orientation.DEFAULT */,
};
exports.ANDROID_LAND_LDPI_SCREEN = {
    ...
    width: 320,
    height: 240,
    density: "land-ldpi" /* Density.LAND_LDPI */,
    orientation: "landscape" /* Orientation.LANDSCAPE */,
};
exports.ANDROID_LAND_MDPI_SCREEN = {
    ...
    width: 480,
    height: 320,
    density: "land-mdpi" /* Density.LAND_MDPI */,
    orientation: "landscape" /* Orientation.LANDSCAPE */,
};
exports.ANDROID_LAND_HDPI_SCREEN = {
    ...
    width: 800,
    height: 480,
    density: "land-hdpi" /* Density.LAND_HDPI */,
    orientation: "landscape" /* Orientation.LANDSCAPE */,
};
exports.ANDROID_LAND_XHDPI_SCREEN = {
    ...
    width: 1280,
    height: 720,
    density: "land-xhdpi" /* Density.LAND_XHDPI */,
    orientation: "landscape" /* Orientation.LANDSCAPE */,
};
exports.ANDROID_LAND_XXHDPI_SCREEN = {
    ...
    width: 1600,
    height: 960,
    density: "land-xxhdpi" /* Density.LAND_XXHDPI */,
    orientation: "landscape" /* Orientation.LANDSCAPE */,
};
exports.ANDROID_LAND_XXXHDPI_SCREEN = {
    ...
    width: 1920,
    height: 1280,
    density: "land-xxxhdpi" /* Density.LAND_XXXHDPI */,
    orientation: "landscape" /* Orientation.LANDSCAPE */,
};
exports.ANDROID_PORT_LDPI_SCREEN = {
    ...
    width: 240,
    height: 320,
    density: "port-ldpi" /* Density.PORT_LDPI */,
...
exports.ANDROID_PORT_MDPI_SCREEN = {
    ...
    width: 320,
    height: 480,
    density: "port-mdpi" /* Density.PORT_MDPI */,
    orientation: "portrait" /* Orientation.PORTRAIT */,
};
exports.ANDROID_PORT_HDPI_SCREEN = {
    platform: "android" /* Platform.ANDROID */,
    ...
    width: 480,
    height: 800,
    density: "port-hdpi" /* Density.PORT_HDPI */,
    orientation: "portrait" /* Orientation.PORTRAIT */,
};
exports.ANDROID_PORT_XHDPI_SCREEN = {
    ...
    width: 720,
    height: 1280,
    density: "port-xhdpi" /* Density.PORT_XHDPI */,
    orientation: "portrait" /* Orientation.PORTRAIT */,
};
exports.ANDROID_PORT_XXHDPI_SCREEN = {
    ...
    width: 960,
    height: 1600,
    density: "port-xxhdpi" /* Density.PORT_XXHDPI */,
    orientation: "portrait" /* Orientation.PORTRAIT */,
};
exports.ANDROID_PORT_XXXHDPI_SCREEN = {
    ...
    width: 1280,
    height: 1920,
    density: "port-xxxhdpi" /* Density.PORT_XXXHDPI */,
    orientation: "portrait" /* Orientation.PORTRAIT */,
};
