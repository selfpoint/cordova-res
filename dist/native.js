...
const debug = (0, debug_1.default)('cordova-res:native');
...
const IOS_ICONS = [
    {
        type: "ios-icon" /* NativeResourceType.IOS_ICON */,
...
const IOS_SPLASHES = [
    {
        type: "ios-splash" /* NativeResourceType.IOS_SPLASH */,
...
const ANDROID_ICONS = [
    {
        type: "android-legacy" /* NativeResourceType.ANDROID_LEGACY */,
        source: resources_1.ANDROID_MDPI_ICON.src,
        target: 'mipmap-mdpi/ic_launcher.png',
    },
    {
        type: "android-round" /* NativeResourceType.ANDROID_ROUND */,
        source: resources_1.ANDROID_MDPI_ICON.src,
        target: 'mipmap-mdpi/ic_launcher_round.png',
    },
    {
        type: "android-adaptive-foreground" /* NativeResourceType.ANDROID_ADAPTIVE_FOREGROUND */,
        source: resources_1.ANDROID_MDPI_ADAPTIVE_ICON.foreground,
        target: 'mipmap-mdpi/ic_launcher_foreground.png',
    },
    {
        type: "android-adaptive-background" /* NativeResourceType.ANDROID_ADAPTIVE_BACKGROUND */,
...
const ANDROID_SPLASHES = [
    {
        type: "android-splash" /* NativeResourceType.ANDROID_SPLASH */,
...
async function copyImages(sourcePath, targetPath, images, errstream) {
    await Promise.all(images.map(async (item) => {
        ...
        try {
            await (0, utils_fs_1.copy)(source, target);
        }
        catch (e) {
            debug(e);
...
async function copyToNativeProject(platform, resourcesDirectory, nativeProject, shouldCopyIcons, shouldCopySplash, logstream, errstream) {
    ...
    if (platform === "ios" /* Platform.IOS */) {
        ...
        errstream === null || errstream === void 0 ? void 0 : errstream.write(util_1.default.format('WARN:\tCopying to native projects is not supported for the %s platform', (0, platform_1.prettyPlatform)(platform)) + '\n');
        return;
    }
    logstream === null || logstream === void 0 ? void 0 : logstream.write(util_1.default.format(`Copied %s resource items to %s`, count, (0, platform_1.prettyPlatform)(platform)) + '\n');
}
